...
VL_MODULE(Vtop) {
  public:
    ...
    CData/*0:0*/ top__DOT__l1__DOT__entry[3];
    ...
    SData/*15:0*/ top__DOT____Vcellinp__l1__in_index_act[3];
    SData/*15:0*/ top__DOT____Vcellout__l1__out_index[3];
    SData/*15:0*/ top__DOT__l1__DOT____Vcellinp__activation__in_index[3];
